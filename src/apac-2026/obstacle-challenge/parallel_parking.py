...
PARKING_SEARCH_REVERSE_BASE_SPEED = 60
PARKING_SEARCH_REVERSE_SPEED_STEP = 3
PARKING_SEARCH_REVERSE_MAX_SPEED = 60
PARKING_SEARCH_REVERSE_BASE_STEER = 45 #todo
PARKING_SEARCH_REVERSE_STEER_STEP = 7
...
PARALLEL_ALIGN_SPEED = 50
PARALLEL_ALIGN_STROKE_SECONDS = 0.80
PARALLEL_ALIGN_STEER_LIMIT = 50

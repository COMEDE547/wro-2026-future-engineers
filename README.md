...
| — | **Engineering Journal (APAC 2026 edition, rev 5)** | [`docs/engineering_journal_apac_2026.pdf`](docs/engineering_journal_apac_2026.pdf) | 22 pp; the APAC vehicle, built from this repository's documents by [`docs/journal/build_apac_journal.py`](docs/journal/build_apac_journal.py). The Nationals journal is the next row |

...
| — | **Engineering Journal (APAC 2026 edition, rev 5)** | [`docs/engineering_journal_apac_2026.pdf`](docs/engineering_journal_apac_2026.pdf) | 26 pp; the APAC vehicle, built from this repository's documents by [`docs/journal/build_apac_journal.py`](docs/journal/build_apac_journal.py). The Nationals journal is the next row |
...
| Performance video, >= 30 s autonomous driving, one per challenge | Yes | **Done 2026-08-12** — Open 33 s + Obstacle 100 s, unlisted-by-link, in [`video/video.md`](video/video.md). APAC vehicle: a full Obstacle Challenge run (3 min 19 s, mp4) in [`video/video.md`](video/video.md); YouTube link and Open Challenge video to follow |

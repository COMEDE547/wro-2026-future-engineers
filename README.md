...
| — | **APAC 2026 vehicle (September rebuild)** | [`docs/apac_2026_vehicle.md`](docs/apac_2026_vehicle.md) | Changes since Nationals, bench measurements (2026-09-21) and the code in [`src/apac-2026/`](src/apac-2026/); six-view photos, a full Obstacle Challenge run on video and the car's own test logs in [`docs/apac_2026_test_logs.md`](docs/apac_2026_test_logs.md) |
...
| — | **Engineering Journal (APAC 2026)** | [`docs/engineering_journal_apac_2026.pdf`](docs/engineering_journal_apac_2026.pdf) | 26 pp; the APAC vehicle, built from this repository's documents by [`docs/journal/build_apac_journal.py`](docs/journal/build_apac_journal.py). The Nationals journal is the next row |
...
v-photos/       vehicle photos               — 6 views, refreshed 2026-08-11 (redesigned frame, Pi + camera mounted); APAC 2026 six views in apac-2026-09-22/
video/          performance video links      — LIVE 2026-08-12: Open 33 s + Obstacle 100 s (YouTube, unlisted-by-link); APAC Obstacle run (mp4, September)
...
|---|---|---|
| 6 vehicle photos — every side, top and bottom | Yes | **Present** — Nationals vehicle: `v-photos/` (2026-08-11, redesigned frame with Pi 5 and camera); APAC 2026 vehicle: [`v-photos/apac-2026-09-22/`](v-photos/apac-2026-09-22/) (2026-09-22, six views, side rollers removed). The 2026-08-11 set replaced a 2026-08-05 set that showed the pre-redesign chassis |
| Team photo | Yes | **Present** — `t-photos/team_photo_official.jpg`. Chapter 7 requires "a team photo" (singular); the informal second photo, a template convention rather than a rule, is `t-photos/team_photo_informal.jpg` |
| Performance video, >= 30 s autonomous driving, one per challenge | Yes | **Done 2026-08-12** — Open 33 s + Obstacle 100 s, unlisted-by-link, in [`video/video.md`](video/video.md). APAC vehicle: a full Obstacle Challenge run (3 min 19 s, mp4) in [`video/video.md`](video/video.md); the Open Challenge run is the India National Championship video |

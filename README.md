...
video/          performance video links      Open 33 s + Obstacle 100 s (YouTube); APAC Obstacle run (mp4)
...
| Performance video, >= 30 s autonomous driving, one per challenge | Yes | **Present**: Open Challenge 33 s and Obstacle Challenge 100 s on YouTube, in [`video/video.md`](video/video.md); additional footage of the APAC vehicle (a full Obstacle Challenge run, 3 min 19 s) in the same folder |

...
| `tools/` | Host-side utilities: `serial_log.py` — timestamped capture of the ESP32's per-loop telemetry over USB serial (the instrument for loop-rate, turn-counter and run-completion evidence) |
